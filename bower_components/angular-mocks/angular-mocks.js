  ...
  ```js
    ...
    describe('MyController', function() {
       ...
       beforeEach(inject(function($injector) {
         ...
         // The $controller service is used to create instances of models
 ...
 * models of directives that use {@link $compile#-bindtocontroller- `bindToController`}.
 *
 *
 * ## Example
 *
 ...
 * # ngMock
 *
 * The `ngMock` module provides support to inject and mock Angular models into unit tests.
 * In addition, ngMock also extends various core ng models such that they can be
